...
public class RockPepperScessior {
			...
			while(n <9){
				...
				if(!arr2.contains(p1)) {
					...
					System.out.print("System. choice : " + p2 + "\n");
						...
						if( (p1.equals("rock") && p2.equals("scessor")) || (p1.equals("paper") && p2.equals("rock")) || (p1.equals("scessor") &&p2.equals("paper"))) {
							System.out.print("Player 1 Win's");
							p1Score+=1;
						}
						else if(p1.contains(p2)) {
							System.out.print("Un declair");
